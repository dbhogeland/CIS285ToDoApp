...
public class TaskCategoryMap {
     ...
     */
    HashMap<String, String> taskCat = new HashMap<String, String>(); 
    
    // public void setCatTask( ) // WIP still need to think of a way to actually assign as task to a category. Might require GUI controller first to directly assign it?
}
